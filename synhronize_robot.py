...
#----------------------------------------------
# It is script  synchronize the robot Hwashi movements 
...
def SyncWait():
    ...
    Use SyncSet  to define how many robots must be synchronized together."""
    global SYNC_COUNT
...
print('Main program finished! Succerful!')
